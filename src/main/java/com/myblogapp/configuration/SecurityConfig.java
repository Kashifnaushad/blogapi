...
import com.myblogapp.security.CustomUserDetailsService;
...
//        UserDetails kashif = User.builder().username("kashif").password
...
//        return new InMemoryUserDetailsManager(kashif,admin);
//    }
}
